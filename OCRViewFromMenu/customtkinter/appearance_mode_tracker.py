...
try:
    ...
    if Version(darkdetect.__version__) < Version("0.3.1"):
        sys.stderr.write(
            "WARNING: You have to upgrade the darkdetect library: pip3 install --upgrade darkdetect\n"
        )
    ...
    sys.stderr.write(
        "customtkinter.appearance_mode_tracker warning: failed to import darkdetect"
    )
